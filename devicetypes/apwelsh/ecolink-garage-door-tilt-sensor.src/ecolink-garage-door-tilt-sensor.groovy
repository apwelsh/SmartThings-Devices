 ...
 *
 *  Adapterd from SmartThings: Z-Wave Door/Window Sensor
 *
 *  Author: SmartThings / Armand Welsh
 *  Date: 2013-11-3 / 2016-04-07
 */

metadata {
	definition (name: "EcoLink Garage Door Tilt Sensor", namespace: "apwelsh", author: "Armand Welsh") {
		capability "Contact Sensor"
		capability "Sensor"
		capability "Battery"
		capability "Configuration"

		//z-wave device raw description: 0 0 0x2001 0 0 0 a 0x30 0x71 0x72 0x86 0x85 0x84 0x80 0x70 0xEF 0x20

		fingerprint deviceId: "0x2001", inClusters: "0x30,0x71,0x72,0x86,0x85,0x84,0x80,0x70,0xEF,0x20", manufacturer: "EcoLink", model: "TILTZWAVE2-ECO"
	}
	...
	tiles {
		...
		valueTile("battery", "device.battery", inactiveLabel: false, decoration: "flat") {
			state "battery", label:'Battery Good', unit:""
		}
