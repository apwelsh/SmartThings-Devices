 ...
 *  
 *  Adapted from Cooper RF9500 device type
 *  Author: Armand Welsh
 *  
 */
metadata {
	definition (name: "Cooper RF9542-Z", namespace: "apwelsh", author: "Armand Welsh") {
		capability "Switch"
		capability "Switch Level"
		capability "Button"
        capability "Actuator"

        // 0 0 0x1202 0 0 0 d 0x26 0x27 0x75 0x86 0x70 0x71 0x85 0x77 0x2B 0x2C 0x72 0x73 0x87
        
		fingerprint deviceId: "0x1202", inClusters: "0x26,0x27,0x75,0x86,0x70,0x71,0x85,0x77,0x2B,0x2C,0x72,0x73,0x87", manufacturer: "Cooper", Model: "RF9542-Z"
	}
